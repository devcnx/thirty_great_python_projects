...
class TaxCalculator:
    def __init__(self):
        ...
        self.income_entry = ctk.CTkEntry(self.window, placeholder_text='Enter Your Income', justify='center')
        ...
        self.tax_rate_entry = ctk.CTkEntry(self.window, placeholder_text='Enter Tax Rate', justify='center')
        ...
        self.result_entry = ctk.CTkEntry(self.window, placeholder_text='Tax', justify='center')
